...
import utilities.DriverUtility;
 public class RegisterStepDefinition extends Base {
	...
	@When("^User fills Register form with bellow information$")
	public void user_fills_Register_form_with_bellow_information(DataTable personalInfo) throws Throwable {
...
//		registerPageObj.enterConfirmPassValue(dataValues.get(0).get(4));
		// when we use List<List> for procissing data talble we use .raw method
		// when we use List<Map> for processing DataTable we use . asMaps (String.class,String.class)
	...
	@Then("^User should see the message of '(.+)'$")
	public void user_should_see_the_message_of_Your_Account_Has_Been_Created(String message) throws Throwable {
